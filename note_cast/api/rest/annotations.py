...
# @router.post("/")
# def create_note(quote_node: Union[ QuoteNode , ApiBaseResponse, None] = Depends(fetch_quote)):
#     detail = QuotePydantic(
#         q_id=quote_node.q_id,
#         transcript=quote_node.transcript,
#         visible=quote_node.visible,
#     )
...
@router.post("/")
def create_note(q_id : str = Body(...), note_text : str = Body(..., )):
    ...
