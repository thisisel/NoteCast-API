...
# from note_cast.db._models import User, Podcast, Episode, Quote, Note
    ...
    "p1": {
        ...
        "_episodes": {
            "e1": {
                ...
                "air_date_db": "2016-08-16 04:04:00",
                "_quotes": {
                    "q1": {
            ...
            "e2": {
                ...
                "length_s": 1596,
                "description": "This week on Hidden Brain, Shankar talks to Google's Laszlo Bock for insider tips and insights about what works — and what doesn't work — in recruiting, motivating, and retaining a talented workforce.\n",
                "air_date_db": "2016-06-07 04:00:00",
                "_quotes": {
                    "q1": {
    ...
    "p2": {
        ...
        "_episodes": {
            "e1": {
                ...
                "air_date_db": "2016-06-29 03:59:00",
                "_quotes": {
                    "q1": {
            ...
            "e2": {
                ...
                "air_date_db": "2016-02-17 04:59:32",
                "_quotes": {
                    "q1": {
...
def seed_podcast_items(podcasts : dict):
    ...
    for p_v in podcasts.values():
        ...
        for e_v in episodes.values():
           ...
           e_db.published_for.connect(p_db, {"date": e_v.get("air_date_db")})
